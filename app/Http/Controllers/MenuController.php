...
class MenuController extends Controller
{
    ...
    {
        $no = 1;
        $karakter = DB::table('masterkarakteristik')->paginate(10);
        return view('menu/index',compact('karakter','no'));
    }
    ...
    {
        // die(dd($request));
        DB::table('masterkarakteristik')->insert([
          'nama'        => $request->nama,
...
public function store_user(Request $request)
{
    ...
    DB::table('history_log')->insert([
        ...
        'keterangan'    => 'Telah Menambahkan User '.$request->nama,
        'url'           => '/user',
        'kategori'      => 'Tambah User',
        'status_baca'   => 0,
        'tanggal'       => date('Y-m-d')
    ]);
...
public function update_user(Request $request ,$id)
{
    ...
    DB::table('history_log')->insert([
        'nama_user'     => Auth::user()->name,
        'keterangan'    => 'Telah Merubah User '.$request->nama,
        'url'           => '/user/'.$id.'/edit',
        'kategori'      => 'Edit',
        'status_baca'   => 0,
        'tanggal'       => date('Y-m-d')
